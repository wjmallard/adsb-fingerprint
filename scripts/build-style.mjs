...
// (protomaps-themes-base), dark flavor to match the live-map UI. Output is a
// complete, self-contained MapLibre style pointing at the locally vendored
// tiles, glyphs, and sprite — no runtime deps. Adapted from
// ~/Github/offline-maps/scripts/build-style.mjs.
//
//   npm i protomaps-themes-base@4.5.0        # one-time
//   node scripts/build-style.mjs [dark|light|white|grayscale|black]
//
...
const flavor = process.argv[2] || "dark";
const root = join(dirname(fileURLToPath(import.meta.url)), "..");
const out = join(root, "src/adsb_fingerprint/web/static/styles/basemap.json");
